...
import { UsersColumns } from "../../../tables/columns/users.column";
...
export const UserListPage: React.FC = () => {
  ...
  const {
    ...
    setCurrentPage,
    loading,
  } = usePaginatedList(getAllUsers, searchQuery, filterStatus, itemsPerPage);
  ...
  const columns = UsersColumns(handleStatusToggle);
