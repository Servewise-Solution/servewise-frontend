...
const dummyNotifications = [
  {
    ...
    description: "A new user has signed up on the platform.",
    time: "5 mins ago",
  },
  {
    id: "2",
    title: "New Provider Onboarded",
    description: "A service provider has completed onboarding.",
    time: "15 mins ago",
  },
  {
    id: "3",
    title: "Service Request Spike",
    description: "Unusual increase in service requests detected.",
    time: "1 hour ago",
  },
  {
    id: "4",
    title: "Payment Issue Reported",
    description: "A provider reported a payment settlement issue.",
    time: "3 hours ago",
  },
  {
    id: "5",
    title: "System Update Deployed",
    description: "A new system update was deployed successfully.",
    time: "Yesterday",
  },
];
