...
import type { AuthLayoutProps } from "../types/component.types";
...
const AuthLayout: React.FC<AuthLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen flex overflow-hidden relative">
      <div className="absolute inset-0 bg-linear-to-br from-teal-50 via-blue-50 to-indigo-100"></div>
        ...
        >
          ...
          >
            <div className="text-center">
              <div className="mb-4">
                <h1 className="text-5xl font-bold text-slate-800 tracking-wide">
                  Serve<span className="text-cyan-500">Wise</span>
                </h1>
              ...
              <div className="flex items-center justify-center mb-4">
                <div className="h-0.5 w-72 bg-cyan-500"></div>
              ...
              <p className="text-xs text-slate-600 mt-4 tracking-widest font-medium">
                VEHICLE SERVICE & REPAIR PLATFORM
              </p>
            </div>
          </div>
        </motion.div>
