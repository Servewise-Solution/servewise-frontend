        ...
        <div className="flex flex-col lg:flex-row justify-between items-start mb-12 pb-8 border-b border-slate-700">
          <div className="mb-8 lg:mb-0">
            ...
            <p className="text-slate-300 text-lg max-w-md leading-relaxed">
              Empowering service providers with smart tools to manage jobs,
              customers, and payments efficiently.
            </p>
          </div>
          ...
          <div className="w-full lg:w-96">
            ...
            <p className="text-slate-300 mb-4 text-sm">
              Get updates on new features, service requests, and platform
              improvements.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <ul className="space-y-3">
              {["About Servewise", "Our Team", "Careers", "Partner Program"].map(
                (link) => (
                  <li key={link}>
                    <a
                      href="#"
            ...
            <ul className="space-y-4">
              <li className="flex items-start group">
                ...
                <span className="text-slate-300 text-sm leading-relaxed">
                  Servewise HQ, Business District, City, Country
                </span>
              </li>
