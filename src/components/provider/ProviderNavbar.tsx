...
const dummyNotifications = [
  {
    ...
    description: "You have received a new service request nearby.",
    time: "5 mins ago",
  },
  {
    id: "2",
    title: "Job Assigned",
    description: "A service job has been assigned to you.",
    time: "30 mins ago",
  },
  {
    id: "3",
    title: "Payment Released",
    description: "Payment for completed service has been released.",
    time: "2 hours ago",
  },
];
