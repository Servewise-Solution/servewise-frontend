        ...
        <>
          ...
          <div className="fixed inset-0 z-9999 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              <motion.div
                className={`w-full transform overflow-hidden rounded-lg bg-linear-to-b from-gray-50 to-white px-8 py-6 text-center align-middle shadow-xl border border-gray-100 ${className || "max-w-2xl"}`}
