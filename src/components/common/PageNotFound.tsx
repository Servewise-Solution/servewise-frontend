...
import type { PageNotFoundProps } from "../../types/component.types";
  ...
  return (
    ...
    >
      <div className="max-w-2xl w-full text-center">
        <div className="mb-8">
          <div
            className={`inline-flex items-center justify-center w-20 h-20 rounded-full bg-linear-to-r ${config.color} mb-6`}
          >
          ...
          <ul className="space-y-2 text-left">
            {config.suggestions.map((suggestion, index) => (
              <li key={index} className="flex items-center text-gray-600">
                <div
                  className={`w-2 h-2 rounded-full bg-linear-to-r ${config.color} mr-3 shrink-0`}
                ></div>
                {suggestion}
              </li>
            ))}
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-500 text-sm">
            ...
            <a
              ...
              className={`text-transparent bg-clip-text bg-linear-to-r ${config.color} hover:underline`}
            >
              support@fixify.com
            </a>
          </p>
